...
export const userRoles = [
  {
    value: "user",
    label: "User",
    bgcoverColor: "bg-[#FDF2FA]",
    textcoverColor: "text-[#C11574]",
  },
  {
    value: "admin",
    label: "Admin",
    bgcoverColor: "bg-[#ECFDF3]",
    textcoverColor: "text-[#027A48]",
  },
];
...
export const borrowStatuses = [
  {
    value: "overdue",
    label: "Overdue",
    bgcoverColor: "bg-[#FFF1F3]",
    textcoverColor: "text-[#C01048]",
  },
  {
    value: "borrowed",
    label: "Borrowed",
    bgcoverColor: "bg-[#F9F5FF]",
    textcoverColor: "text-[#6941C6]",
  },
  {
    value: "returned",
    label: "Returned",
    bgcoverColor: "bg-[#F0F9FF]",
    textcoverColor: "text-[#026AA2]",
  },
];
